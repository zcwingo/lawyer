<?php
	...
	**/
	...
	function arbitration ($m='') {
		$money = 0;
		if ($m<=5000) {
			$money = 100;
		} elseif($m>5000&&$m<=50000) {
			$money = ($m-100)*0.04+100;
		} elseif($m>50000&&$m<=100000) {
			$money = ($m-100)*0.03+100;
		} elseif($m>100000&&$m<=200000) {
			$money = ($m-100)*0.02+100;
		} elseif($m>200000&&$m<=500000) {
			$money = ($m-100)*0.015+100;
		} elseif($m>500000&&$m<=1000000) {
			$money = ($m-100)*0.008+100;
		} elseif($m>1000000) {
			$money = ($m-100)*0.004+100;
		} else {
			$money = 0;
		}
		return $money.'元';
